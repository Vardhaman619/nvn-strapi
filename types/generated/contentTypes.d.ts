...
export interface ApiEventsCalendarEventsCalendar
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Events: Schema.Attribute.Component<'custom.event', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiParentsTestimonialParentsTestimonial
  extends Struct.CollectionTypeSchema {
  collectionName: 'parents_testimonials';
  info: {
    description: '';
    displayName: 'Parents Testimonial';
    pluralName: 'parents-testimonials';
    singularName: 'parents-testimonial';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::parents-testimonial.parents-testimonial'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
